...
- **Интеграция с Hugging Face:** ответы и аналитика строятся на бесплатной текстовой модели (по умолчанию `mistralai/Mistral-7B-Instruct-v0.2`) через Inference API.
