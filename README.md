...
Автономный Telegram-чатбот «девушка», построенный на базе [GramJS](https://gram.js.org/) и модели OpenAI ChatGPT. Бот анализирует весь диалог, ведёт историю общения, обновляет краткое резюме отношений и при необходимости проявляет инициативу, продолжая общение самостоятельно.
...
- **Интеграция с ChatGPT:** для ответов и аналитики используется OpenAI Chat Completions API.
...
- `src/ai-client.js` — запросы к OpenAI API, генерация ответов и аналитических сводок.
