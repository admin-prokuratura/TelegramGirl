...
- **Интеграция с Hugging Face:** ответы и аналитика строятся на бесплатной текстовой модели (по умолчанию `meta-llama/Meta-Llama-3-8B-Instruct`) через Inference API.
...
2. Создайте файл `.env` и заполните его значениями:
   ...
   > Если вы оставите старое значение `mistralai/Mistral-7B-Instruct-*`, конфиг автоматически переключится на актуальную модель `meta-llama/Meta-Llama-3-8B-Instruct`.
